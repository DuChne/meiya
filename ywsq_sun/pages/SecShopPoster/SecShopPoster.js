Component({
    ...
    methods: {
        drawPoster: function(t) {
            ...
            i.setFillStyle("#fff"), i.fillRect(0, 0, 750, 1100), i.drawImage("./bg.png", 168, 95, 533, 74);
            var a = {
                obj: i,
                str: "我发现了一个心得，也给你推荐一下~",
                initHeight: 140,
                initWidth: 241,
                titleHeight: 60,
                canvasWidth: 560,
            ...
            this.drawText(a);
            i.setFillStyle("#fff"), i.fillRect(55, 228, 640, 820), i.setStrokeStyle("#eee"), 

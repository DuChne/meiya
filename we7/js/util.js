...
util.url = function(e, t) {
    var a = getApp(), n = a.siteInfo.siteroot + "?i=" + a.siteInfo.uniacid + "&t=" + a.siteInfo.multiid + "&m=ywsq_sun&v=" + a.siteInfo.version + "&from=wxapp&";
    if (e && ((e = e.split("/"))[0] && (n += "c=" + e[0] + "&"), e[1] && (n += "a=" + e[1] + "&"), 
    e[2] && (n += "do=" + e[2] + "&"), e[3] && (n += "act=" + e[3])), t && "object" === (void 0 === t ? "undefined" : _typeof(t))) for (var r in t) r && t.hasOwnProperty(params) && t[r] && (n += r + "=" + t[r] + "&");
    return n;
}, util.request = function(n) {
    require("underscore.js");
    var e = require("md5.js"), r = getApp();
    (n = n || {}).cachetime = n.cachetime ? n.cachetime : 0, n.showLoading = void 0 === n.showLoading || n.showLoading;
    var t = wx.getStorageSync("userInfo").sessionid, i = n.url;
    if (-1 == i.indexOf("http://") && -1 == i.indexOf("https://") && (i = util.url(i)), 
    getUrlParam(i, "state") || n.data && n.data.state || !t || (i = i + "&state=we7sid-" + t), 
    !n.data || !n.data.m) {
        var a = getCurrentPages();
        a && (a = a[getCurrentPages().length - 1]).__route__;
    }
    ...
    if (wx.showNavigationBarLoading(), n.showLoading && util.showLoading(), n.cachetime) {
        var s = e(i), u = wx.getStorageSync(s), c = Date.parse(new Date());
        if (u && u.data) {
            if (u.expire > c) return n.complete && "function" == typeof n.complete && n.complete(u), 
            n.success && "function" == typeof n.success && n.success(u), console.log("cache:" + i), 
    ...
    g && (n.header.authorization = "Bearer {" + g + "}"), wx.request({
        url: i,
        data: n.data ? n.data : {},
        header: n.header ? n.header : {},
        method: n.method ? n.method : "POST",
        success: function(e) {
